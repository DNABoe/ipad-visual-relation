  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col gap-0 p-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-border bg-gradient-to-br from-background to-muted/20 flex-shrink-0">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <DialogTitle className="text-lg font-bold mb-1.5 text-foreground">Send Invitation</DialogTitle>
        ...
        <ScrollArea className="flex-1 min-h-0">
          <div className="px-6 py-4">
            <div className="space-y-4">
              <div className="rounded-lg border border-primary/30 bg-gradient-to-br from-primary/5 to-primary/10 p-4 shadow-sm space-y-3">
              ...
              <div className="rounded-lg border border-border bg-card shadow-sm overflow-hidden">
                <div className="bg-gradient-to-br from-muted/50 to-muted/30 px-4 py-2.5 border-b border-border">
              ...
              <div className="rounded-lg border border-border bg-muted/20 overflow-hidden shadow-sm">
