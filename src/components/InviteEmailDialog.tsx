...
This is an automated invitation from RelEye. If you received this email in error, please disregard it.`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} modal={true}>
      <DialogContent className="max-w-[1200px] w-[90vw] max-h-[90vh] flex flex-col gap-0 p-0">
        <DialogHeader className="px-6 pt-5 pb-4 border-b border-border bg-gradient-to-br from-background to-muted/20 flex-shrink-0">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 p-2.5 rounded-lg bg-gradient-to-br from-primary/20 to-accent/20 border border-primary/30 shadow-md">
              <EnvelopeSimple className="w-5 h-5 text-primary" weight="duotone" />
            </div>
            <div className="flex-1 min-w-0">
              <DialogTitle className="text-lg font-bold mb-1 text-foreground">Send Invitation</DialogTitle>
          ...
          <div className="px-6 py-5">
            <div className="grid grid-cols-2 gap-5">
              <div className="space-y-3.5">
                <div className="rounded-lg border border-primary/30 bg-gradient-to-br from-primary/5 to-primary/10 p-4 shadow-sm space-y-2.5">
                ...
                <div className="space-y-2.5">
                  ...
                  <Button 
                    ...
                    className="w-full h-9 text-sm font-semibold gap-2 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 shadow-md hover:shadow-lg transition-all"
                  >
                    <EnvelopeSimple className="w-4 h-4" weight="duotone" />
                    Open in Email App
                  </Button>
                  <div className="grid grid-cols-2 gap-2">
                    <Button 
                      ...
                      className="h-8 flex items-center justify-center gap-1.5 font-medium text-sm hover:border-primary/50 hover:bg-primary/5"
                    >
                      {copiedFull ? (
                        <>
                        ...
                        <>
                          ...
                          <span className="text-xs">Copy Full Email</span>
                        </>
                      )}
                    </Button>
                    <Button 
                    ...
                    >
                      {copiedLink ? (
                        ...
                        <>
                          <Copy className="w-3.5 h-3.5" />
                          <span className="text-xs">Copy Link Only</span>
                        </>
                      )}
                    </Button>
                  </div>
                ...
                <div className="rounded-lg border border-border bg-card shadow-sm overflow-hidden">
                  <div className="bg-gradient-to-br from-muted/50 to-muted/30 px-3.5 py-2.5 border-b border-border">
                    <div className="flex items-center gap-2">
                      <Logo size={24} showText={false} animated={false} />
                  ...
                  <div className="px-3.5 py-2.5 space-y-2">
                    <div className="grid grid-cols-[80px_1fr] gap-x-2.5 gap-y-1.5 text-sm">
              ...
              <div className="rounded-lg border border-border bg-muted/20 overflow-hidden shadow-sm flex flex-col">
                <div className="bg-muted/40 px-3.5 py-2 border-b border-border flex-shrink-0">
        ...
        <div className="px-6 py-3.5 border-t border-border bg-gradient-to-br from-muted/20 to-background flex-shrink-0">
          <Button 
            variant="outline" 
            onClick={() => onOpenChange(false)}
            className="w-full h-9 font-medium text-sm hover:bg-muted/50"
          >
            Close
          </Button>
        </div>
